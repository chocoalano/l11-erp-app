...
class GroupAttendancePolicy
{
    ...
    {
        return $user->can('view_any_groupattendance');
    }
    ...
    {
        return $user->can('view_groupattendance');
    }
    ...
    {
        return $user->can('create_groupattendance');
    }
    ...
    {
        return $user->can('update_groupattendance');
    }
    ...
    {
        return $user->can('delete_groupattendance');
    }
    ...
    {
        return $user->can('delete_any_groupattendance');
    }
