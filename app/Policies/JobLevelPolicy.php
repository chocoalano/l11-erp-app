...
class JobLevelPolicy
{
    ...
    {
        return $user->can('view_any_job::level');
    }
    ...
    {
        return $user->can('view_job::level');
    }
    ...
    {
        return $user->can('create_job::level');
    }
    ...
    {
        return $user->can('update_job::level');
    }
    ...
    {
        return $user->can('delete_job::level');
    }
    ...
    {
        return $user->can('delete_any_job::level');
    }
