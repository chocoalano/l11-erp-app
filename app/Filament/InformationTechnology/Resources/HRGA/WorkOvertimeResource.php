...
use App\Filament\InformationTechnology\Resources\HRGA\WorkOvertimeResource\Pages;
use App\Filament\InformationTechnology\Resources\HRGA\WorkOvertimeResource\RelationManagers;
        ...
        return $table
            ->modifyQueryUsing(function (Builder $query) {
                ...
                if ($u->hasRole(['super_admin', 'Administrator HR'])) {
                    ...
                    return $query->whereHas('userMember', function($q) use($userId) {
