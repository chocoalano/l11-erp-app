...
class StatsUserOverview extends BaseWidget
{
    protected function getStats(): array
    {
        ...
        $count_level_total = \App\Models\SystemSetup\JobLevel::count();
        $count_position_total = \App\Models\SystemSetup\JobPosition::count();
        $count_org_total = \App\Models\SystemSetup\Organization::count();
        return [
