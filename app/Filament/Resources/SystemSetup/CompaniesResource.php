...
use App\Filament\Resources\SystemSetup\CompaniesResource\Pages;
use App\Filament\Resources\SystemSetup\CompaniesResource\RelationManagers;
    ...
    public static function table(Table $table): Table
    {
        ...
        ->headerActions([
            Tables\Actions\ExportAction::make()
                ->exporter(\App\Filament\Exports\SystemSetup\CompanyExporter::class)
                ->icon('fas-file-export'),
            Tables\Actions\ImportAction::make()
                ->importer(\App\Filament\Imports\SystemSetup\CompanyImporter::class)
